...
export default function DeleteAlcalde({
  isOpen,
  onClose,
  alcalde,
  onConfirm,
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-slate-500">{alcalde.departamento}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm text-slate-800">{alcalde.departamento}</span>
                    </div>

                    <div className="flex justify-between items-center">
                      <span className="text-sm font-medium text-slate-600">Partido</span>
                      <span className="text-sm text-slate-800">{alcalde.partidoPolitico}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span
                        className={`px-2.5 py-1 text-xs font-semibold rounded-full ${
                          alcalde.estadoPostulacion === 'Aprobado'
                            ? 'bg-green-100 text-green-700'
                            : alcalde.estadoPostulacion === 'Pendiente'
